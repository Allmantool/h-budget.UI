...
- For UI templates and styles, load the linked styling standard; it is the detailed owner for BEM, CSS/SCSS architecture, and the required HTML/CSS/SCSS review.
